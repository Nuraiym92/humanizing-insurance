...
import footerbg from "../../assets/images/bg-pattern-footer-desktop.svg";
      ...
      <footer className='footer'>
       <div className='footer__bg'>
         ...
         <div className='footer__head'>
                  ...
                  <div className='footer__head-links'>
                      <ul className='footer__head-links-list'>
                          <li >
                          <a href="#"><img src={fb}></img></a>
                          </li>
                          <li >
                          <a href="#"><img src={tw}></img></a>
                          </li>
                          <li >
                          <a href="#"><img src={pt}></img></a>
                          </li>
                          <li >
              ...
              <div className="footer__items">
                  <div className="footer__items-item">
                      <h3 className='footer__items-item-title'>Our company</h3>
                          <ul className='footer__items-item-list'>
                  ...
                  <div className="footer__items-item">
                      <h3 className='footer__items-item-title'>Help me</h3>
                          <ul className='footer__items-item-list'>
                            <li><a href="#">FAQ</a></li>
                  ...
                  <div className="footer__items-item">
                      <h3 className='footer__items-item-title'>Contacts</h3>
                          <ul className='footer__items-item-list'>
                  ...
                  <div className="footer__items-item">
                      <h3 className='footer__items-item-title'>Others</h3>
                          <ul className='footer__items-item-list'>
